class BtrfsProgs < Formula
  ...
  url "https://mirrors.edge.kernel.org/pub/linux/kernel/people/kdave/btrfs-progs/btrfs-progs-v6.9.1.tar.xz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, x86_64_linux: "2337033bd15ff6a5627c108dbaf9a9e312bf0895cb2a73274c747b7085a69fe8"
  end
