class Fatal < Formula
  ...
  url "https://github.com/facebook/fatal/releases/download/v2024.11.11.00/fatal-v2024.11.11.00.tar.gz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, all: "c077ef28bf696fd2e758ad766a04a2290efb74ef749859e60bb6a873d8e1ded9"
  end
