class Wireshark < Formula
  ...
  url "https://www.wireshark.org/download/src/all-versions/wireshark-4.4.4.tar.xz"
  mirror "https://1.eu.dl.wireshark.org/src/all-versions/wireshark-4.4.4.tar.xz"
