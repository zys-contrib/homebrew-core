class Eva < Formula
  ...
  url "https://github.com/oppiliappan/eva/archive/refs/tags/v0.3.1.tar.gz"
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, arm64_linux:    "936591ea0016a4154b9f48a7b341639982e6c57b5f53562abc4f9c09366ff8d8"
